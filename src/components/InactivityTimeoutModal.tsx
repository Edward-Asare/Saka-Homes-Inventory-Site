      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-md bg-white rounded-3xl shadow-2xl border border-slate-200/80 p-6 sm:p-7 overflow-hidden text-center"
          >
            ...
            <div className="flex flex-col items-center space-y-4 pt-2">
              ...
              <div className="space-y-1.5">
                <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-100/80 text-amber-900 text-[11px] font-extrabold uppercase tracking-wider">
              ...
              <div className="w-full bg-slate-50 border border-amber-200/60 rounded-2xl p-4 flex flex-col items-center justify-center space-y-1 shadow-inner">
                <div className="flex items-baseline gap-1.5">
                  <span className="text-4xl font-extrabold font-mono text-[#E54818] tracking-tight">
              ...
              <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-2.5 pt-2">
                <button
                  ...
                  className="w-full py-3.5 px-4 bg-[#E54818] hover:bg-[#C83A0F] text-white rounded-xl text-xs font-bold shadow-md shadow-orange-600/20 active:scale-[0.98] transition-all flex items-center justify-center gap-2"
                >
                ...
                <button
                  ...
                  type="button"
                  onClick={onLogout}
                  className="w-full py-3.5 px-4 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl text-xs font-bold active:scale-[0.98] transition-all flex items-center justify-center gap-2"
                >
